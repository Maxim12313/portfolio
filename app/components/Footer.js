export default function Footer() {
  return (
    <footer className="w-full h-20 flex flex-col items-center justify-center mt-20">
      <div className="flex flex-col p-2 items-center">
        <div className="onlySmall flex flex-row items-center justify-start">
          <a
            href="https://github.com/Maxim12313"
            target="_blank"
            className="icon"
          >
            <svg
          ...
          <a
            href="https://www.linkedin.com/in/maxim-kim-b057bb240/"
            target="_blank"
            className="icon"
          >
            <svg
          ...
          <a
            href="https://leetcode.com/u/maxi24/"
            target="_blank"
            className="icon"
          >
            <svg
          ...
          <a href="mailto:maximk@umich.edu" target="_blank" className="icon">
            <svg
              className="fill-inherit"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
