  ...
  return (
    <div
      className="fixed right-16 bottom-0 vertical-line min-h-[40%] flex flex-col 
                    items-center justify-start space-y-5"
    >
      <a href="https://github.com/Maxim12313" target="_blank">
        <svg
          className="fill-lightest-slate"
      ...
      <a href="https://leetcode.com/u/maxi24/" target="_blank">
        <svg
          className="fill-lightest-slate"
          xmlns="http://www.w3.org/2000/svg"
          width="24"
      ...
      <a href="mailto:maximk@umich.edu" target="_blank">
        <svg
          className="fill-lightest-slate"
          xmlns="http://www.w3.org/2000/svg"
          width="24"
